...
class SearchViewModel @Inject constructor(
    ...
    private val _postList = MutableLiveData<List<ArticleEntity>>(searchRepository.getPosts())
    val postList = _postList

    private val _userList = MutableLiveData<List<UserSearchEntity>>(searchRepository.getUsers())
    val userList = _userList

    private val _tagList = MutableLiveData<List<String>>(searchRepository.getTags())
